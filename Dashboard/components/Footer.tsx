          ...
          <div className="space-y-6 flex flex-col items-center lg:items-start pr-4 md:pr-16 text-center lg:text-left">
            ...
            <ul className="space-y-4 text-[8px] md:text-[11px] font-bold uppercase tracking-widest text-white/50">
              <li className="flex flex-col lg:flex-row items-center gap-3 hover:text-white transition-colors cursor-pointer">
                <i className="fa-solid fa-shield-halved text-[#d4af37] text-base"></i> <span>DMCC Registered</span>
              </li>
              <li className="flex flex-col lg:flex-row items-center gap-3 hover:text-white transition-colors cursor-pointer">
                <i className="fa-solid fa-award text-[#d4af37] text-base"></i> <span>LBMA Standard</span>
              </li>
              <li className="flex flex-col lg:flex-row items-center gap-3 hover:text-white transition-colors cursor-pointer">
                <i className="fa-solid fa-lock text-[#d4af37] text-base"></i> <span>Multi-Sig Security</span>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4 text-[8px] md:text-[11px] font-bold uppercase tracking-widest text-white/50">
              <li className="flex items-center gap-3 hover:text-white transition-colors cursor-pointer">
                <a href="mailto:info@ipg-invest.ae" className="flex items-center gap-3">
                  <i className="fa-solid fa-envelope text-base"></i> <span className="break-all">info@ipg-invest.ae</span>
                </a>
              </li>
              <li className="flex items-center gap-3 hover:text-white transition-colors cursor-pointer">
                <a href="https://t.me/GoldenShareClub" target="_blank" className="flex items-center gap-3">
                  <i className="fa-solid fa-paper-plane text-base"></i> <span>Official Telegram</span>
                </a>
              </li>
              <li className="flex items-center gap-3 hover:text-white transition-colors cursor-pointer">
                <a href="https://wa.me/971529657370" target="_blank" className="flex items-center gap-3">
                  <i className="fa-solid fa-comments text-base"></i> <span>{t.footerSupport}</span>
                </a>
              </li>
            </ul>
          </div>
